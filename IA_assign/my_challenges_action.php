...
$sql = "INSERT INTO challenge (sem, year, challenge, plan, remark)
VALUES (" . $sem . ", '". $year . "', '" . $challenge . "','" . $plan . "', '" . $remark . "')";
...
if($uploadOk){
$sql = "INSERT INTO challenge (sem, year, challenge, plan, remark, img_path)
VALUES (" . $sem . ", '". $year . "', '" . $challenge . "','" . $plan . "', '" . $remark . "', '" . $uploadfileName . "')";
$status = insertTo_DBTable($conn, $sql);
if ($status) {
